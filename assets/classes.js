...
// Criando Little Monster
class LittleMonster extends Character {
    constructor() {
        super('Little Mosnter');
...
class Stage {
    ...
    doAttack(attacking, attacked) {
        ...
        if(actualAttack > actualDefense) {
            ...
            attacked.life -= dano;
            this.log.addMessage(`${attacking.name} causou ${dano.toFixed(2)} de dano em ${attacked.name}.`);
        } else {
